...
var handlers = {
  ...
  'LaunchRequest': function() {
    this.emit(':ask', 'Welcome to the Big Ten! ' + 
	  'Which fight song would you like to hear me sing?');
  },
  ...
  'AMAZON.HelpIntent': function () {    
    this.emit(':ask', 'I can sing any Big Ten fight song...' + 
	  'For example, to hear me sing, say: Alexa, sing the Michigan fight song. Or ' +
	  'Alexa, sing Across the Field. Or Alexa, sing the Victors...' + 
	  'To cancel, say Cancel. Would you like for me to sing a fight song?')
  },
